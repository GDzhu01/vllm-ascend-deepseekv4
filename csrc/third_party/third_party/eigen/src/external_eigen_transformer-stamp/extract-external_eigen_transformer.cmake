...
#
get_filename_component(filename "/home/m00663269/vllm-ascend-deepseekv4/csrc/third_party/download/eigen/eigen-5.0.0.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/m00663269/vllm-ascend-deepseekv4/csrc/third_party/eigen" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-external_eigen_transformer${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-external_eigen_transformer${i}")
