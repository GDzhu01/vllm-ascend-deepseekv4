...
ge::graphStatus GroupedMatmulSwigluQuantV2BaseTiling::ParseInputAndAttr()
{
    ...
    const auto swigluLimtPtr = attr->GetAttrPointer<float>(ATTR_INDEX_SWIGLU_LIMIT);
    float swigluLimt_ = swigluLimtPtr != nullptr ? *swigluLimtPtr : 1000000.0f;
    tilingData_.gmmSwigluQuantV2BaseParams.set_singleN(swigluLimt_);
