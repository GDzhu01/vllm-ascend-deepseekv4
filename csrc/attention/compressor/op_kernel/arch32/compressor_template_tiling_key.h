...
ASCENDC_TPL_ARGS_DECL(compressor, // 算子唯一标识，与opType保持一致
    ...
    // bit:9-10  rope_dtype 0:BF16 1:FP16 2:FP32
    ASCENDC_TPL_UINT_DECL(ROPE_DTYPE, ASCENDC_TPL_2_BW, ASCENDC_TPL_UI_LIST, 0, 1, 2),
    // bit:11-12  cache_mode 1:CONTINUOUS 2:cycle
    ASCENDC_TPL_UINT_DECL(CACHE_MODE, ASCENDC_TPL_2_BW, ASCENDC_TPL_UI_LIST, 1, 2),
    // bit:13-14  template_id 0:empty_tensor 1:normal 2:full load
...
ASCENDC_TPL_SEL(
    ...
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_UINT_SEL(X_LAYOUT, ASCENDC_TPL_UI_LIST, 0, 1),
                        ...
                        ASCENDC_TPL_UINT_SEL(ROPE_DTYPE, ASCENDC_TPL_UI_LIST, 0, 1, 2),
