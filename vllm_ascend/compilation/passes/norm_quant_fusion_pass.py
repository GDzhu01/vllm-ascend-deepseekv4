...
from vllm_ascend.utils import (enable_custom_op, AscendDeviceType, get_ascend_device_type)
...
class AddRMSNormQuantFusionPass(VllmInductorPass):
    ...
    def __init__(self, vllm_config: VllmConfig):
        ...
        for eps in common_epsilons:
            ...
            if enable_custom_op() and get_ascend_device_type() not in {AscendDeviceType.A5}:
