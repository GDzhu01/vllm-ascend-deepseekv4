...
def _get_kv_cache_groups_uniform_page_size_with_multi_groups(
    ...
    # MTP/draft layers are extra dense layers that do not pair with the
    # compress-pair pattern of main attention layers. Reserve one slot per
    # MTP layer so they don't shrink the number of KV tensors and drop the
