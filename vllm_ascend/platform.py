...
class NPUPlatform(Platform):
    ...
    supported_quantization: list[str] = [ASCEND_QUANTIZATION_METHOD, COMPRESSED_TENSORS_METHOD, FP8_METHOD]
    ...
    def pre_register_and_update(cls, parser: FlexibleArgumentParser | None = None) -> None:
        ...
        if not is_310p():
            from vllm_ascend.quantization import AscendCompressedTensorsConfig, AscendModelSlimConfig, AscendFp8Config  # noqa: F401
        else:
