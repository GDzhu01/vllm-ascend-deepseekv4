...
def rejection_random_sample_kernel(
    ...
    for req_i in range(BLOCK_SIZE):
        not_greedy = extension.get_element(not_greedy_mask, (req_i, ))
        if not_greedy:
            rejected = False
            start_idx = extension.get_element(start_idxs, (req_i, ))
            req_idx = block_idx * BLOCK_SIZE + req_i
            num_draft_tokens = extension.get_element(n_num_draft_tokens, (req_i, ))
